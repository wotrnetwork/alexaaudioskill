...
STREAMS = [
  {
    ...
    "metadata": {
      ...
      "subtitle": 'A subtitle for Old Time Radio USA',
      "art": {
        "sources": [
          {
            "contentDescription": 'example image',
            "url": 'https://static.wixstatic.com/media/7d32c5_e16b6b84072a49b9ac5802126e0258ce~mv2.png/v1/fill/w_992,h_785,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/test.png',
            "widthPixels": 512,
            "heightPixels": 512
          }
        ]
